...
var CustomHeaderComponent = /** @class */ (function () {
    function CustomHeaderComponent(router) {
        this.router = router;
    }
    CustomHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.linkList = this.router.config.map(function (el) { return el.path; }).filter(function (el) { return el !== ''; });
        this.router.events.pipe(Object(rxjs_internal_operators_filter__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (ev) { return ev instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]; })).subscribe(function (val) {
            _this.filterLinkListByActualRoute(val.url);
        });
    };
    CustomHeaderComponent.prototype.goTo = function (route) {
        this.router.navigate([route]);
    };
    CustomHeaderComponent.prototype.filterLinkListByActualRoute = function (actualRoute) {
        console.log("actualRoute", actualRoute);
        console.log("pre", this.linkList);
        this.linkList = this.router.config.map(function (el) { return el.path; }).filter(function (el) {
            if (el !== '')
                return el !== actualRoute.replace("/", '').trim();
        });
        console.log("post", this.linkList);
    };
    CustomHeaderComponent.ctorParameters = function () { return [
...
var CustomNoticesComponent = /** @class */ (function () {
    function CustomNoticesComponent() {
        this.cardList = [1, 2, 3, 4, 5, 6, 7];
    }
    CustomNoticesComponent.prototype.ngOnInit = function () {
    };
...
var MobileMenuComponent = /** @class */ (function () {
    ...
    MobileMenuComponent.prototype.ngAfterViewChecked = function () {
        if (this.showDropDownFlag) {
            ...
            var tempo_1 = this.mouseover$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (arg) {
                tempo2_1.unsubscribe();
                console.log('SOPRA');
            });
            var tempo2_1 = this.mouseout$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (arg) {
    ...
    MobileMenuComponent.prototype.ngAfterViewInit = function () {
        /*   this.mouseover$ = fromEvent( this.ciao.nativeElement, 'click');
          this.mouseover$
            .subscribe(arg => console.log(arg)); */
        /*  console.log(this.ciao) */
    };
    MobileMenuComponent.prototype.showDropDown = function () {
        this.showDropDownFlag = !this.showDropDownFlag;
    };
    MobileMenuComponent.prototype.bounce = function ($event) {
        var _this = this;
        var subscribe = this.interval.subscribe(function (val) {
            _this.ciao.nativeElement.style.transform = "rotate(" + val + "deg)";
        });
    };
...
var ReceiverComponentComponent = /** @class */ (function () {
    function ReceiverComponentComponent(testService) {
    ...
    ReceiverComponentComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.form.get('search').valueChanges
            ...
            if (search.length > 2) {
                ...
                _this.lista = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.listaOrigin);
                if (_this.selected.length > 0) {
                    try {
                        for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_this.selected), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var el = _c.value;
                            var index2 = _this.lista.indexOf(el);
                            _this.lista.splice(index2, 1);
                        }
                    }
                ...
                _this.lista = _this.lista.filter(function (el) { return el.indexOf(search) > -1; });
                console.log('Search lista => ', _this.lista);
                console.log('Search listaOrigin => ', _this.lista);
            }
        });
    };
    /* showConfig() {
    ...
    ReceiverComponentComponent.prototype.selectItem = function ($event) {
        this.selected.push($event);
        this.selected = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.selected);
        this.form.controls["search"].reset('');
        this.lista = [];
    };
    ReceiverComponentComponent.prototype.removeSelectedCard = function (search_term) {
    ...
    ReceiverComponentComponent.ctorParameters = function () { return [
    ...
    return ReceiverComponentComponent;
}());
...
var TestService = /** @class */ (function () {
    ...
    TestService.prototype.getInfoProjectStats = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])([{ BimProjectCount: 10,
                NoBimProjectCount: 10 },
            { BimProjectCount: 22,
                NoBimProjectCount: 22 }]);
    };
    TestService.prototype.postInfo = function (stat) {
        var jsonStat = Object(class_transformer__WEBPACK_IMPORTED_MODULE_4__["classToPlain"])(stat);
